...
# ---
# name: capsule-organizations
# deployed: true
# config: index
# title: Capsule Organizations
# description: Returns a list of organizations from Capsule
# params:
#   - name: properties
#     type: array
...
def get_data(params):
    ...
    while True:
        ...
        for header_item in data:
            if header_item.get('type') != 'organisation': # limit results to person type
                continue
