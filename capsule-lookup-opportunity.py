...
# ---
# name: capsule-lookup-opportunity
# deployed: true
# title: Capsule Lookup Opportunity
# description: Returns a single opportunity from Capsule
# params:
#   - name: id
#     type: string
...
def flexio_handler(flex):
    ...
    params = OrderedDict()
    params['id'] = {'required': True, 'type': 'string', 'coerce': str}
    ...
    try:
        ...
        url = 'https://api.capsulecrm.com/api/v2/opportunities/' + input['id']
        headers = {
        ...
        result = [[property_map.get(p, lambda item: '')(opportunity) or '' for p in properties]]
